...
class SocialController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Social']))
		{
            ...
            if ($icon->saveAs(Yii::getPathOfAlias('webroot').'/content/social/'.$icon->name))
            {
                //echo CVarDumper::dump($img, 10, TRUE);exit;
                $model->icon = $icon;
            }
	...
	{
		$dataProvider=new CActiveDataProvider('Social');
	 ...
	 * @param Social $model the model to be validated
	 */
